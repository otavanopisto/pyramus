...
public class PersonDAO extends PyramusEntityDAO<Person> {
  ...
  public SearchResult<Person> searchPersonsBasic(int resultsPerPage, int page, String queryText) {
    return searchPersonsBasic(resultsPerPage, page, queryText, StudentFilter.SKIP_INACTIVE);
  }

  public SearchResult<Person> searchPersonsBasic(int resultsPerPage, int page, String queryText, StudentFilter studentFilter) {
    return searchPersonsBasic(resultsPerPage, page, queryText, studentFilter, null, null);
  }
  
  @SuppressWarnings("unchecked")
  public SearchResult<Person> searchPersonsBasic(int resultsPerPage, int page, String queryText, StudentFilter studentFilter, StudyProgramme studyProgramme, StudentGroup studentGroup) {
