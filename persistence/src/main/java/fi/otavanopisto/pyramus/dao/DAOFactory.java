...
public class DAOFactory {
  ...
  public fi.otavanopisto.pyramus.dao.application.ApplicationEmailVerificationDAO getApplicationEmailVerificationDAO() {
    return (ApplicationEmailVerificationDAO) findByClass(fi.otavanopisto.pyramus.dao.application.ApplicationEmailVerificationDAO.class);
  }
  ...
  public StudentLanguageSkillLevelDAO getStudentLanguageSkillLevelDAO() {
    return (StudentLanguageSkillLevelDAO) findByClass(StudentLanguageSkillLevelDAO.class);
  }
  ...
  public StudentCardDAO getStudentCardDAO() {
    return (StudentCardDAO) findByClass(StudentCardDAO.class);
  }
  ...
  public StudentParentInvitationDAO getStudentParentInvitationDAO() {
    return (StudentParentInvitationDAO) findByClass(StudentParentInvitationDAO.class);
  }
