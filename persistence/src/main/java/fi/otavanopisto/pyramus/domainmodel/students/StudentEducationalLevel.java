...
public class StudentEducationalLevel implements ArchivableEntity {
  ...
  @TableGenerator(name="StudentEducationalLevel", allocationSize=1, table = "hibernate_sequences", pkColumnName = "sequence_name", valueColumnName = "sequence_next_hi_value")
  private Long id;
