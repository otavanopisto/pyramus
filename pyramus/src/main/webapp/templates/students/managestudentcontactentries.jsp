    ...
    <script type="text/javascript">
      ...
      function getEntryTypeName(entryType) {
        ...
        if (entryType == 'FACE2FACE')
          ...
          if (entryType == 'MUIKKU')
            entryTypeName = '<fmt:message key="students.manageStudentContactEntries.contactEntry.types.muikku"/>';
                    ...
                    <form method="post" id="newContactEntryForm.${student.id}" name="newContactEntryForm_${student.id}" onsubmit="saveEvent(event, ${student.id});">
                      ...
                      <div class="genericFormSection">                            
                        ...
                        <select name="entryType">
                          ...
                          <option value="MUIKKU"><fmt:message key="students.manageStudentContactEntries.contactEntry.types.muikku"/></option>
                        </select>
                      </div>            
                      <div class="genericFormSection">                            
                        <jsp:include page="/templates/generic/fragments/formtitle.jsp">
