...
<ix:extensionHook name="generic.header.javascript"/>
  ...
  <div id="GUI_headerNavigationContainer">
    ...
    <c:if test="${not empty loggedUserFeatures['APPLICATION_MANAGEMENT']}">
      <ul id="GUI_MENU_applicationsContainer">
        <li id="GUI_MENU_applicationsLink">
          ...
          <ul id="GUI_MENU_applicationsItemContainer" class="GUI_MENU_itemContainer">
            ...
            <li class="GUI_MENU_item"><a href="${pageContext.request.contextPath}/applications/createemailsignature.page" class="GUI_MENU_itemLink"><fmt:message key="generic.navigation.createEmailSignature"/></a></li>
