...
<t:setupwizard-template>
  <jsp:attribute name="script">
    <script type="text/javascript" src="${pageContext.request.contextPath}/scripts/gui/system/setupwizard/contacttypes.js"></script>
  </jsp:attribute>
  <jsp:body>
    ...
    <form method="post" action="">
      <div id="educationTypes" class="tabContent">
        ...
        <div id="contactTypesTable">
          <div id="noContactTypesAddedMessageContainer">
            <fmt:message key="system.setupwizard.contactTypes.addNew" />
          </div>
        </div>
      </div>
