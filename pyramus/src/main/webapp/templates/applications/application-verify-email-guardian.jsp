      ...
      <c:otherwise>
        ...
        <section class="application-description application-description--edit">
          <div class="application-description__edit">
            ...
            <div class="application-description__edit-content">Hakemustietojen suojaamiseksi pyydämme vielä täyttämään alla olevaan kenttään hakijan syntymäajan. Tämän myötä sähköpostiosoitteesi on vahvistettu ja voimme olla sinuun yhteydessä hakemuksen käsittelyn aikana.</div>
          </div>
        </section>
