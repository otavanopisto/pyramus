  ...
  <body>
    ...
    <footer class="application-footer">
      ...
      <div class="application-footer__links">
        ...
        <a href="https://otavia.fi/wp-content/uploads/2020/02/Opiskelija-ja-opintotietorekisterin-tietosuojaseloste_Otavia.pdf" target="top" class="application-footer__external-link">Tietosuojaseloste</a>
      </div>
    </footer>
  </body>
</html>