...
<section class="application-section application-actions">  
  <div class="application-handling-container" style="display:none;">
    ...
    <div class="application-handling-option decline-action" data-state="REJECTED" data-show="PENDING,PROCESSING,APPROVED_BY_SCHOOL,REGISTERED_AS_STUDENT"><span class="application-handling-text decline-application">Hylk‰‰ hakemus</span></div>
