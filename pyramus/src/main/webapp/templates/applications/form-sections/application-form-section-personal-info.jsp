...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
  ...
  <section class="form-section section-personal-info" style="display:none;">
    ...
    <div class="form-section__field-container field-birthday">
      ...
      <input type="text" id="field-birthday" name="field-birthday">
    ...
    <div class="form-section__field-container field-ssn-end">
      ...
      <input type="text" id="field-ssn-end" name="field-ssn-end" maxlength="4" style="text-transform:uppercase;">
    ...
    <div class="form-section__field-container field-sex">
      ...
      <select id="field-sex" name="field-sex">
    ...
    <div class="form-section__field-container field-nationality">
      ...
      <select id="field-nationality" name="field-nationality" data-source="/1/applications/nationalities" data-preselect="Suomi">
        <option value="">-- Valitse --</option>
      </select>
    </div>
    ...
    <div class="form-section__field-container field-language">
      ...
      <select id="field-language" name="field-language" data-source="/1/applications/languages" data-preselect="suomi">
        <option value="">-- Valitse --</option>
      </select>
    </div>
    ...
    <div class="form-section__field-container field-phone">
      ...
      <input type="text" id="field-phone" name="field-phone">
    ...
    <div class="form-section__field-container field-email-secondary">
      ...
      <input type="email" id="field-email-secondary" name="field-email-secondary">
    </div>
