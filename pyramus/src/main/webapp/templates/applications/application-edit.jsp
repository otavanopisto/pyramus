...
<html>
  ...
  <body>
    ...
    <section class="application-description">
      ...
      <div class="application-description__line application-description__line--nettiperuskoulu">
        <div class="application-description__line-header">
      ...
      <div class="application-description__line application-description__line--nettilukio">
        <div class="application-description__line-header">
      ...
      <div class="application-description__line application-description__line--aineopiskelu">
        <div class="application-description__line-header">
      ...
      <div class="application-description__line application-description__line--aikuislukio">
         <div class="application-description__line-header">
      ...
      <div class="application-description__line application-description__line--maahanmuuttajakoulutus">
        <div class="application-description__line-header">
