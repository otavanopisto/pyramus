...
<form id="application-form" class="application-form" data-save-url="${saveUrl}" data-done-page="${donePage}">
  ...
  <section class="form-section section-line">
    ...
    <div class="field-container dependent" data-dependent-field="field-line" data-dependent-values="laakislinja">
      <p>Lääkislinjalla kerrataan ja syvennetään lukion biologian, fysiikan, kemian ja matematiikan oppimääriä, valmistaudutaan lääketieteellisen pääsykokeisiin harjoittelemalla eri tehtävätyyppien vastaustekniikoita ja tehdään lopuksi simuloitu pääsykoe.</p>
    </div>
