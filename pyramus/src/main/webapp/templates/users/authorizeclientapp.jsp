...
<body class="muikku-login-body">
  <div class="muikku-login-card-wrapper">
    <c:choose>
      <c:when test="${loginStatus ne 'ERROR'}">
      ...
      <c:otherwise>
        <section class="muikku-login-card">
          ...
          <main class="muikku-login-container">
            ...
            <div class="muikku-login-container-row">
              Logging in to the requested client application was cancelled due to missing, inactive or misconfigured client application, unsupported request type or misconfiguration of the login request.
            </div>
