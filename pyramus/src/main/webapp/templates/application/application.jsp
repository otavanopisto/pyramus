	      ...
	      <section class="form-section section-attachments" data-skip="true">
	        ...
	        <div class="field-container field-attachments">
              ...
              <input type="file" id="field-attachments" name="field-attachments" multiple="true" style="display:none;">
	            <div class="field-attachments-selector">
                <div>Lisää liitteitä klikkaamalla tästä tai raahaamalla niitä tähän laatikkoon
                <div>Voit lisätä korkeintaan viisi liitettä, joiden yhteiskoon on oltava alle 10 MB</div>
              </div>
