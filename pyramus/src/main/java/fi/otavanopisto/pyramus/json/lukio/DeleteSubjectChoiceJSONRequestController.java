...
public class DeleteSubjectChoiceJSONRequestController extends JSONRequestController {
  ...
  public void process(JSONRequestContext requestContext) {
    ...
    UserVariableKey studentVariableKey = studentVariableKeyDAO.findById(requestContext.getLong("subjectChoiceKey"));
    ...
    String value = requestContext.getString("subjectChoiceValue");
