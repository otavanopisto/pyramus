...
import fi.pyramus.rest.model.StudentVariableKey;
...
public class StudentVariableTestsIT extends AbstractRESTServiceTest {
  ...
  public void testCreateStudentVariables() {
    StudentVariableKey studentVariable = new StudentVariableKey("crevar", "variable to be created", false, VariableType.TEXT);
  ...
  public void testUpdateStudentVariable() {
    StudentVariableKey studentVariable = new StudentVariableKey("upd", "not updated", false, VariableType.TEXT);
    ...
    try {
      StudentVariableKey updateVariable = new StudentVariableKey("upd", "updated", true, VariableType.NUMBER);
  ...
  public void testDeleteStudentVariable() {
    StudentVariableKey studentVariable = new StudentVariableKey("delete", "variable to be deleted", false, VariableType.TEXT);
