...
public class StudentTestsIT extends AbstractRESTServiceTest {
  ...
  public void testCreateStudent() {
    ...
    response.then()
      ...
      .body("studyTimeEnd", is(getDateString(student.getStudyTimeEnd().getYear(), student.getStudyTimeEnd().getMonth().getValue(), student.getStudyTimeEnd().getDayOfMonth()) ))
      ...
      .body("studyStartDate", is(getDateString(student.getStudyStartDate().getYear(), student.getStudyStartDate().getMonth().getValue(), student.getStudyStartDate().getDayOfMonth()) ))
      .body("studyEndDate", is(getDateString(student.getStudyEndDate().getYear(), student.getStudyEndDate().getMonth().getValue(), student.getStudyEndDate().getDayOfMonth()) ))
  ...
  public void testListStudents() {
    given().headers(getAuthHeaders())
      ...
      .body("studyStartDate[0]", is(getDateString(2010, 1, 1) ))
      ...
      .body("studyStartDate[1]", is(getDateString(2010, 1, 1) ))
  ...
  public void testFindStudent() {
    given().headers(getAuthHeaders())
      ...
      .body("studyStartDate", is(getDateString(2010, 1, 1) ))
  ...
  public void testUpdateStudent() {
    ...
    try {
      ...
      given().headers(getAuthHeaders())
        ...
        .body("studyTimeEnd", is(getDateString(updateStudent.getStudyTimeEnd().getYear(), updateStudent.getStudyTimeEnd().getMonth().getValue(), updateStudent.getStudyTimeEnd().getDayOfMonth()) ))
        ...
        .body("studyStartDate", is(getDateString(updateStudent.getStudyStartDate().getYear(), updateStudent.getStudyStartDate().getMonth().getValue(), updateStudent.getStudyStartDate().getDayOfMonth()) ))        
        .body("studyEndDate", is(getDateString(updateStudent.getStudyEndDate().getYear(), updateStudent.getStudyEndDate().getMonth().getValue(), updateStudent.getStudyEndDate().getDayOfMonth()) ))        
