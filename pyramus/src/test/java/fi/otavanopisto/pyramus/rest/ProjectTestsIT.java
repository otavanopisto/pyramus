...
public class ProjectTestsIT extends AbstractRESTServiceTest {
  ...
  public void testListProjects() {
    given().headers(getAuthHeaders())
      ...
      .body("created[0]", is(getDateString(2010, 6, 6)))
      .body("lastModified[0]", is(getDateString(2010, 6, 6)))
      ...
      .body("created[1]", is(getDateString(2011, 6, 6)))
      .body("lastModified[1]", is(getDateString(2011, 6, 6)))
  ...
  public void testFindProject() {
    given().headers(getAuthHeaders())
      ...
      .body("created", is(getDateString(2010, 6, 6)))
      .body("lastModified", is(getDateString(2010, 6, 6)))
      .body("creatorId", is(1))
