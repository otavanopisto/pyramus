...
//      .body("lastModifierId[1]", is(1))
  ...
  public void testListStudentGroupStudentGuidanceCounselors() {
    ...
    try {
      ...
      try {
        fi.otavanopisto.pyramus.rest.model.StudentGroupUser studentGroupUser = new fi.otavanopisto.pyramus.rest.model.StudentGroupUser(null, COUNCELOR_STAFF_ID, false, false, false, false);
        response = given().headers(getAuthHeaders())
            .contentType("application/json")
    ...
    try {
      ...
      try {
        ...
        try {
          ...
          studentGroupUser = new fi.otavanopisto.pyramus.rest.model.StudentGroupUser(null, COUNCELOR_STAFF_ID2, false, false, false, false);
          response = given().headers(getAuthHeaders())
              .contentType("application/json")
              .body(studentGroupUser)
              .post("/students/studentGroups/{ID}/staffmembers", studentGroupId);
