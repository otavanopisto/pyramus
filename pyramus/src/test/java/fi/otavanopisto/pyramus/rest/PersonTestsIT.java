...
public class PersonTestsIT extends AbstractRESTServiceTest {
  ...
  public void testCreatePerson() {
    ...
    response.then()
      ...
      .body("birthday", is(getDateString(person.getBirthday().getYear(), person.getBirthday().getMonth().getValue(), person.getBirthday().getDayOfMonth()) ))
  ...
  public void testFindPerson() {
    given().headers(getAuthHeaders())
      ...
      .statusCode(200)
      .body("id", is(3) )
      .body("birthday", is(getDateString(1990, 1, 1) ))
      .body("sex", is("FEMALE") )
  ...
  public void testUpdatePerson() {
    ...
    try {
      ...
      given().headers(getAuthHeaders())
        ...
        .body("birthday", is(getDateString(updateStudent.getBirthday().getYear(), updateStudent.getBirthday().getMonth().getValue(), updateStudent.getBirthday().getDayOfMonth()) ))
