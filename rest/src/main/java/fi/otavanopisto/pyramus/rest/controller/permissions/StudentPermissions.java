...
public class StudentPermissions extends AbstractPyramusPermissionCollection implements PyramusPermissionCollection {
  ...
  @Scope (PermissionScope.ENVIRONMENT)
  @DefaultPermissionRoles ({ ADMINISTRATOR, MANAGER, STUDY_PROGRAMME_LEADER, STUDY_GUIDER, TRUSTED_SYSTEM })
  public static final String LIST_STUDENT_SUBJECT_CHOICES = "LIST_STUDENT_SUBJECT_CHOICES";
  ...
  @PermissionFeature(PyramusPermissionFeatures.ONLY_GROUP_STUDENTS)
  public static final String GET_STUDENT_GUIDANCE_RELATION = "GET_STUDENT_GUIDANCE_RELATION";
  ...
  public CourseRoleArchetype[] getDefaultCourseRoles(String permission) throws NoSuchFieldException {
    return super.getDefaultCourseRoles(StudentPermissions.class, permission);
  }
}
