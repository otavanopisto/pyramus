...
@TranquilModel (entityClass = fi.pyramus.domainmodel.base.CourseBase.class, entityType = TranquilModelType.BASE)
public class CourseBaseBase implements fi.tranquil.TranquilModelEntity {
