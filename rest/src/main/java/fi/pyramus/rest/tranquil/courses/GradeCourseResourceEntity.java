...
@TranquilModel  (entityClass = fi.pyramus.domainmodel.courses.GradeCourseResource.class, entityType = TranquilModelType.COMPACT)
public class GradeCourseResourceEntity implements fi.tranquil.TranquilModelEntity {
  ...
  public final static String[] properties = {"id","hours","hourlyCost","unitCost","version","resource","course"};
}
