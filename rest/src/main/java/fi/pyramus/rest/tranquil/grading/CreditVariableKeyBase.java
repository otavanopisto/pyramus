...
@TranquilModel (entityClass = fi.pyramus.domainmodel.grading.CreditVariableKey.class, entityType = TranquilModelType.BASE)
public class CreditVariableKeyBase implements fi.tranquil.TranquilModelEntity {
