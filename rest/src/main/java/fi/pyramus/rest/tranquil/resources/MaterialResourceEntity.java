...
public class MaterialResourceEntity implements fi.tranquil.TranquilModelEntity {
  ...
  public final static String[] properties = {"id","name","archived","version","unitCost","category","tags"};
}
