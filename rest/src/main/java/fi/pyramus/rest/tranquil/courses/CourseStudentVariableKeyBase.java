...
@TranquilModel (entityClass = fi.pyramus.domainmodel.courses.CourseStudentVariableKey.class, entityType = TranquilModelType.BASE)
public class CourseStudentVariableKeyBase implements fi.tranquil.TranquilModelEntity {
