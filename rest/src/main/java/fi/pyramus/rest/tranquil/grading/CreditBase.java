...
@TranquilModel (entityClass = fi.pyramus.domainmodel.grading.Credit.class, entityType = TranquilModelType.BASE)
public class CreditBase implements fi.tranquil.TranquilModelEntity {
