...
@TranquilModel (entityClass = fi.pyramus.domainmodel.resources.Resource.class, entityType = TranquilModelType.UPDATE)
public class ResourceUpdate extends ResourceComplete {
