...
@TranquilModel (entityClass = fi.pyramus.domainmodel.help.HelpItem.class, entityType = TranquilModelType.BASE)
public class HelpItemBase implements fi.tranquil.TranquilModelEntity {
