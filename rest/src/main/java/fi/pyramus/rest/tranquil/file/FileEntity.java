...
public class FileEntity implements fi.tranquil.TranquilModelEntity {
  ...
  public final static String[] properties = {"id","data","contentType","archived","created","lastModified","name","fileName","creator","lastModifier","fileType"};
}
