...
@TranquilModel (entityClass = fi.pyramus.domainmodel.resources.MaterialResource.class, entityType = TranquilModelType.UPDATE)
public class MaterialResourceUpdate extends MaterialResourceComplete {
