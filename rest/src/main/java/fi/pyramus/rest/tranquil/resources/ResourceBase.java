...
@TranquilModel (entityClass = fi.pyramus.domainmodel.resources.Resource.class, entityType = TranquilModelType.BASE)
public class ResourceBase implements fi.tranquil.TranquilModelEntity {
  ...
  public final static String[] properties = {"id","name","archived","tags","resourceType","nameSortable","version"};
}
