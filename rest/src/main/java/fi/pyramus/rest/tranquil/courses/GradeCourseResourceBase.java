...
@TranquilModel (entityClass = fi.pyramus.domainmodel.courses.GradeCourseResource.class, entityType = TranquilModelType.BASE)
public class GradeCourseResourceBase implements fi.tranquil.TranquilModelEntity {
