...
public class HelpFolderEntity implements fi.tranquil.TranquilModelEntity {
  ...
  public final static String[] properties = {"id","created","lastModified","indexColumn","parent","creator","lastModifier","titles","tags","children"};
}
