...
@TranquilModel (entityClass = fi.pyramus.domainmodel.base.CourseBaseVariableKey.class, entityType = TranquilModelType.BASE)
public class CourseBaseVariableKeyBase implements fi.tranquil.TranquilModelEntity {
