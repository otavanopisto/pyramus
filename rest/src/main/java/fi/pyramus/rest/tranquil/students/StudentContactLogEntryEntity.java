...
public class StudentContactLogEntryEntity implements fi.tranquil.TranquilModelEntity {
  ...
  public final static String[] properties = {"id","text","type","entryDate","creatorName","archived","version","student"};
}
