...
@TranquilModel (entityClass = fi.pyramus.domainmodel.grading.ProjectAssessment.class, entityType = TranquilModelType.BASE)
public class ProjectAssessmentBase implements fi.tranquil.TranquilModelEntity {
