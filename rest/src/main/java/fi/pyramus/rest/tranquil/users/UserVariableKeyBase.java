...
@TranquilModel (entityClass = fi.pyramus.domainmodel.users.UserVariableKey.class, entityType = TranquilModelType.BASE)
public class UserVariableKeyBase implements fi.tranquil.TranquilModelEntity {
