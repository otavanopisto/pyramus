...
public class HelpPageEntity implements fi.tranquil.TranquilModelEntity {
  ...
  public final static String[] properties = {"id","created","lastModified","indexColumn","parent","creator","lastModifier","titles","tags","contents"};
}
