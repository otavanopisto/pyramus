...
@TranquilModel (entityClass = fi.pyramus.domainmodel.students.StudentVariableKey.class, entityType = TranquilModelType.BASE)
public class StudentVariableKeyBase implements fi.tranquil.TranquilModelEntity {
