...
@TranquilModel (entityClass = fi.pyramus.domainmodel.reports.ReportCategory.class, entityType = TranquilModelType.BASE)
public class ReportCategoryBase implements fi.tranquil.TranquilModelEntity {
