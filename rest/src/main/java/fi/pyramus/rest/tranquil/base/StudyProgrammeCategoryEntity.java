...
public class StudyProgrammeCategoryEntity implements fi.tranquil.TranquilModelEntity {
  ...
  public final static String[] properties = {"id","name","archived","version","educationType"};
}
