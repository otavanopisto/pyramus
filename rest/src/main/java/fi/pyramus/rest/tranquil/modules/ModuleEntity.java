...
public class ModuleEntity implements fi.tranquil.TranquilModelEntity {
  ...
  public final static String[] properties = {"id","name","created","lastModified","description","archived","courseNumber","version","maxParticipantCount","creator","lastModifier","subject","courseEducationTypeByEducationTypeId","courseLength","courseEducationTypes","variables","moduleComponents","tags"};
}
