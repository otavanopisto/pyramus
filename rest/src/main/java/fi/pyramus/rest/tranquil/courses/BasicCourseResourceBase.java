...
@TranquilModel (entityClass = fi.pyramus.domainmodel.courses.BasicCourseResource.class, entityType = TranquilModelType.BASE)
public class BasicCourseResourceBase implements fi.tranquil.TranquilModelEntity {
  ...
  public final static String[] properties = {"id","hours","hourlyCost","unitCost","units","version"};
}
