...
public class ProjectAssessmentEntity implements fi.tranquil.TranquilModelEntity {
  ...
  public final static String[] properties = {"id","date","verbalAssessment","archived","creditType","version","grade","assessingUser","studentProject"};
}
