...
@TranquilModel (entityClass = fi.pyramus.domainmodel.base.PhoneNumber.class, entityType = TranquilModelType.COMPLETE)
public class PhoneNumberComplete extends PhoneNumberBase {
