...
@TranquilModel (entityClass = fi.pyramus.domainmodel.courses.GradeCourseResource.class, entityType = TranquilModelType.COMPLETE)
public class GradeCourseResourceComplete extends GradeCourseResourceBase {
